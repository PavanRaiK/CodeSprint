...
def create_dataset():
    ...
    def add_edge(from_id, to_id, distance=None, stairs=False, elevator=False, accessible=True, difficulty=0, turn_complexity=0, notes=""):
        ...
        if distance is None:
            if n1 and n2 and n1["floor"] == n2["floor"]:
                dx = n1["x"] - n2["x"]
                dy = n1["y"] - n2["y"]
                scale = 0.35 if n1["floor"] == -1 else 0.25
    ...
    # ==========================================
    # West Lift Bank: exists on floors 0, 1, 2
    for f in range(3):
        nodes.append({
            "id": f"ELEV_1_{f}",
    ...
    # Staircase B: connects ALL floors 0..5
    for f in range(6):
        nodes.append({
            "id": f"STAIR_B_{f}",
    ...
    # Staircase A: connects floors 0..4
    for f in range(5):
        nodes.append({
            "id": f"STAIR_A_{f}",
    ...
    # Staircase C: connects floors 0..3
    for f in range(4):
        nodes.append({
            "id": f"STAIR_C_{f}",
    ...
    # Staircase D: connects floors 0..3
    for f in range(4):
        nodes.append({
            "id": f"STAIR_D_{f}",
    ...
    # Connect Workshop circulation to main building corridor
    add_edge("STAIR_WS_0", "N_G_N_CENTRAL_JCT", distance=18.0, notes="North corridor connection to Workshop")
    add_edge("STAIR_WS_2", "N_2_W_N", distance=16.0, notes="2nd Floor bridge connection to Workshop")

    # ==========================================
    # CAMPUS LEVEL — OUTDOOR GROUNDS & BUILDINGS (FLOOR -1)
    # Strictly aligned to visible roads and exact map pins in campus.png
    # ==========================================
    campus_corridor_nodes = [
        # South perimeter & highway
        ("CN_PARKING", "Sahyadri College Parking", "parking", -1, 52, 1462),
        ("CN_PARK_RD", "Parking Access Way", "corridor", -1, 150, 1500),
        ("CN_PETROL", "Hindustan Petroleum (HP Petrol Bunk)", "landmark", -1, 290, 1590),
        ("CN_HIGHWAY_MID", "Campus Perimeter Road along Highway", "corridor", -1, 450, 1480),
        ("CN_SOUTH_GATE", "Campus Security Main Gate & Post Office", "entrance", -1, 650, 1440),

        # Driveway North past Lawn & YS
        ("CN_DRIVEWAY_1", "Main Driveway near Guard Post", "corridor", -1, 600, 1300),
        ("CN_DRIVEWAY_2", "Main Driveway by Event Pavilion", "corridor", -1, 580, 1180),
        ("CN_EVENT_LAWN", "Sahyadri Open Lawn & Event Pavilion", "landmark", -1, 300, 1180),
        ("CN_YS_OFFICE", "Y.S Administrative Annex", "landmark", -1, 720, 1190),

        # Approach to Academic Complex
        ("CN_DRIVEWAY_3", "Academic Complex Approach Road", "corridor", -1, 550, 1020),
        ("CN_MAIN_BLOCK_PORTICO", "Sahyadri College Of Engineering (Main Portico)", "entrance", -1, 480, 920),
        ("CN_MAIN_BLOCK_PIN", "Sahyadri College Of Engineering Pin", "landmark", -1, 415, 977),
        ("CN_MECH_CIVIL_PORTICO", "Mechanical and Civil Block Portico", "entrance", -1, 590, 800),
        ("CN_MECH_CIVIL_PIN", "Mechanical and Civil Block Pin", "landmark", -1, 653, 840),

        # Central Crossroads & Food Court
        ("CN_CENTRAL_ROAD", "Central Campus Crossroads", "intersection", -1, 520, 715),
        ("CN_FOOD_COURT", "Sahyadri Food Court (Cafeteria)", "landmark", -1, 655, 715),
        ("CN_TEL_OFFICE", "Hostel & Telecom Office", "landmark", -1, 835, 740),

        # East road to Guest House & Boys Hostel
        ("CN_EAST_ROAD_1", "East Campus Access Road", "corridor", -1, 880, 680),
        ("CN_EAST_ROAD_2", "Guest House Driveway", "corridor", -1, 930, 580),
        ("CN_GUEST_HOUSE", "Heritage Guest House Sahyadri", "landmark", -1, 994, 526),
        ("CN_HOSTEL_FORK", "Boys Hostel Road Fork", "intersection", -1, 1140, 545),
        ("CN_BOYS_HOSTEL", "Sahyadri Boys Hostel", "landmark", -1, 1320, 640),

        # North road to Cricket Grounds
        ("CN_NORTH_RD_1", "North Road past Food Court", "corridor", -1, 515, 600),
        ("CN_NORTH_RD_2", "North Sports Approach Road", "corridor", -1, 510, 480),
        ("CN_NORTH_RD_CURVE", "Sports Field Curve", "corridor", -1, 540, 390),
        ("CN_CRICKET_APPROACH", "Cricket Ground West Approach", "corridor", -1, 680, 370),
        ("CN_CRICKET_GROUND", "Sahyadri Cricket Ground", "landmark", -1, 820, 375),
        ("CN_CRICKET_PITCH", "Cricket Ground Pavilion & Pitch", "landmark", -1, 850, 205),

        # Northeast road from Hostel Fork to Souhardha Ground
        ("CN_SOUHARDHA_RD_1", "Souhardha Ground Access Road South", "corridor", -1, 1200, 380),
        ("CN_SOUHARDHA_RD_2", "Souhardha Ground Access Road North", "corridor", -1, 1250, 220),
        ("CN_SOUHARDHA_GROUND", "Souhardha Cricket Ground (Sahyadri)", "landmark", -1, 1312, 99),
    ]
    ...
    # Highway perimeter edges
    add_edge("CN_PARKING", "CN_PARK_RD", notes="Parking access")
    add_edge("CN_PARK_RD", "CN_PETROL", notes="Along perimeter highway")
    add_edge("CN_PETROL", "CN_HIGHWAY_MID", notes="Highway to Main Gate")
    add_edge("CN_HIGHWAY_MID", "CN_SOUTH_GATE", notes="Entry gate checkpoint")

    # Main Driveway edges
    add_edge("CN_SOUTH_GATE", "CN_DRIVEWAY_1", notes="Enter campus main road")
    add_edge("CN_DRIVEWAY_1", "CN_DRIVEWAY_2", notes="Main road by Event Lawn")
    add_edge("CN_DRIVEWAY_2", "CN_EVENT_LAWN", notes="Path to Event Lawn pavilion")
    add_edge("CN_DRIVEWAY_2", "CN_YS_OFFICE", notes="Path to Y.S Administrative Annex")

    # Driveway to Academic Complex
    add_edge("CN_DRIVEWAY_2", "CN_DRIVEWAY_3", notes="Continue north towards college buildings")
    add_edge("CN_DRIVEWAY_3", "CN_MAIN_BLOCK_PORTICO", notes="Walkway to Main Academic Block Portico")
    add_edge("CN_MAIN_BLOCK_PORTICO", "CN_MAIN_BLOCK_PIN", notes="Main Academic Block Pin")
    add_edge("CN_DRIVEWAY_3", "CN_MECH_CIVIL_PORTICO", notes="Walkway to Mechanical & Civil Block")
    add_edge("CN_MECH_CIVIL_PORTICO", "CN_MECH_CIVIL_PIN", notes="Mechanical & Civil Block Pin")

    # Central Crossroads & Food Court
    add_edge("CN_DRIVEWAY_3", "CN_CENTRAL_ROAD", notes="Crossroads near Food Court")
    add_edge("CN_CENTRAL_ROAD", "CN_FOOD_COURT", notes="Walkway to Food Court")
    add_edge("CN_FOOD_COURT", "CN_TEL_OFFICE", notes="Paved walkway past Food Court to Tel Office")

    # East Road to Guest House & Hostel
    add_edge("CN_TEL_OFFICE", "CN_EAST_ROAD_1", notes="Road towards Guest House")
    add_edge("CN_EAST_ROAD_1", "CN_EAST_ROAD_2", notes="Road winding north-east")
    add_edge("CN_EAST_ROAD_2", "CN_GUEST_HOUSE", notes="Heritage Guest House driveway")
    add_edge("CN_GUEST_HOUSE", "CN_HOSTEL_FORK", notes="Road continuing to Hostel")
    add_edge("CN_HOSTEL_FORK", "CN_BOYS_HOSTEL", notes="Boys Hostel driveway")

    # North Road to Cricket Grounds
    add_edge("CN_CENTRAL_ROAD", "CN_NORTH_RD_1", notes="North road towards sports field")
    add_edge("CN_NORTH_RD_1", "CN_NORTH_RD_2", notes="North roadway")
    add_edge("CN_NORTH_RD_2", "CN_NORTH_RD_CURVE", notes="Road curving around tree grove")
    add_edge("CN_NORTH_RD_CURVE", "CN_CRICKET_APPROACH", notes="Approach to Cricket Ground")
    add_edge("CN_CRICKET_APPROACH", "CN_CRICKET_GROUND", notes="Cricket Ground entry")
    add_edge("CN_CRICKET_GROUND", "CN_CRICKET_PITCH", notes="North pitch & pavilion access")

    # Northeast road to Souhardha Ground
    add_edge("CN_HOSTEL_FORK", "CN_SOUHARDHA_RD_1", notes="Road to Souhardha ground")
    add_edge("CN_SOUHARDHA_RD_1", "CN_SOUHARDHA_RD_2", notes="Road passing east tree line")
    add_edge("CN_SOUHARDHA_RD_2", "CN_SOUHARDHA_GROUND", notes="Souhardha Cricket Ground entry")
    ...
    # Campus Key Locations / Landmarks (with EXACT pin locations from aerial satellite map)
    campus_locations_data = [
        ("LOC_C_MAIN_BLOCK", "Sahyadri College Of Engineering & Management", "building", -1, 415, 977, "Main Campus", ["main block", "main building", "sahyadri college of engineering", "engineering college", "academic block", "admin block"], "Main 5-story academic complex with Central Courtyards, Principal Chamber, Dean Offices, Classrooms, and Laboratories.", "CN_MAIN_BLOCK_PIN"),
        ("LOC_C_MECH_CIVIL", "Sahyadri College Mechanical and Civil Block", "building", -1, 653, 840, "Mechanical & Civil", ["mechanical and civil block", "mech block", "civil block", "mechanical building", "civil building", "mech civil"], "Dedicated academic and workshop block for Mechanical and Civil Engineering.", "CN_MECH_CIVIL_PIN"),
        ("LOC_C_FOOD_COURT", "Sahyadri Food Court (Cafeteria & Canteen)", "amenity", -1, 655, 715, "Campus Amenities", ["food court", "sahyadri food court", "canteen", "cafeteria", "mess", "dining", "snacks", "cafe", "food"], "Central multi-cuisine food court and student cafeteria.", "CN_FOOD_COURT"),
        ("LOC_C_TEL_OFFICE", "Hostel & Telephone Administration Office", "office", -1, 835, 740, "Administration", ["tel office", "telephone office", "hostel office", "estate office", "telecom office"], "Campus telecommunication, hostel admissions, and facilities office.", "CN_TEL_OFFICE"),
        ("LOC_C_GUEST_HOUSE", "Heritage Guest House Sahyadri College", "facility", -1, 994, 526, "Hospitality", ["heritage guest house", "guest house", "vip guest house", "visitors guesthouse", "heritage house"], "Guest suites for visiting professors, dignitaries, and academic delegates.", "CN_GUEST_HOUSE"),
        ("LOC_C_BOYS_HOSTEL", "Sahyadri Boys Hostel", "hostel", -1, 1320, 640, "Student Housing", ["boys hostel", "sahyadri boys hostel", "hostel", "mens hostel", "residence hall"], "On-campus boys residence and student living quarters.", "CN_BOYS_HOSTEL"),
        ("LOC_C_CRICKET_GROUND", "Sahyadri Cricket Ground", "sports", -1, 820, 375, "Physical Education & Sports", ["sahyadri cricket ground", "cricket ground", "main ground", "sports ground", "playground", "stadium"], "Collegiate turf cricket ground and track field.", "CN_CRICKET_GROUND"),
        ("LOC_C_CRICKET_PITCH", "Cricket Pitch & North Pavillion", "sports", -1, 850, 205, "Physical Education & Sports", ["cricket pitch", "pitch", "pavilion", "north ground"], "Cricket pitch practice wicket and north pavilion.", "CN_CRICKET_PITCH"),
        ("LOC_C_SOUHARDHA_GROUND", "Souhardha Cricket Ground (Sahyadri)", "sports", -1, 1312, 99, "Physical Education & Sports", ["souhardha cricket ground", "souhardha ground", "second cricket ground", "northeast ground"], "Souhardha athletic field and practice cricket oval on the northeast campus perimeter.", "CN_SOUHARDHA_GROUND"),
        ("LOC_C_PARKING", "Sahyadri College Parking", "parking", -1, 52, 1462, "Campus Security", ["parking", "college parking", "sahyadri parking", "car parking", "bike parking", "two wheeler parking"], "Multi-vehicle campus parking lot for two-wheelers, cars, and buses.", "CN_PARKING"),
        ("LOC_C_PETROL_BUNK", "Hindustan Petroleum (HP Petrol Pump)", "amenity", -1, 290, 1590, "Transit", ["hindustan petroleum", "petrol pump", "fuel station", "hp petrol bunk", "gas station"], "Hindustan Petroleum fueling station located right at the national highway campus entry point.", "CN_PETROL"),
        ("LOC_C_SECURITY_GATE", "Campus Security Main Gate & Post Office", "entrance", -1, 650, 1440, "Security & Logistics", ["post office", "security gate", "main gate", "security check", "po", "campus entrance gate"], "Primary security gateway, guard outpost, and on-campus postal clearance window.", "CN_SOUTH_GATE"),
        ("LOC_C_EVENT_LAWN", "Sahyadri Open Lawn & Event Pavilion", "outdoor", -1, 300, 1180, "Student Life", ["open lawn", "event pavilion", "pavilion", "big tent", "fest lawn", "canopy"], "Central event lawn featuring the large canopy structure for convocations and cultural fests.", "CN_EVENT_LAWN"),
        ("LOC_C_YS_ADMIN", "Y.S / Admin Extension", "office", -1, 720, 1190, "Administration", ["ys", "y.s", "admin extension", "south administrative annex"], "Administrative annex and campus security support facility.", "CN_YS_OFFICE")
    ]
    ...
    # Strictly aligned to light-green corridors in ground.png
    # ==========================================
    g_corridors = [
        # South Corridor (y = 880)
        ...
        ("N_G_S_MID", "South Corridor Central Junction", "intersection", 570, 880),
        ...
        ("N_G_W_LIFT", "West Corridor Lift Foyer (Accessible)", "intersection", 215, 760),
        ("N_G_W_STUDY43", "West Corridor Study Space 43 & Meeting 44", "corridor", 215, 550),
        ...
        # North Corridor (y = 190)
        ("N_G_N_EXAM", "North Corridor Exam Section 14", "corridor", 360, 190),
        ("N_G_N_CENTRAL_JCT", "North Corridor Central Junction", "intersection", 560, 190),
        ("N_G_N_STORE", "North Corridor Store 11", "corridor", 650, 190),
        ("N_G_N_DIR", "North Corridor Director's Chamber 10", "corridor", 750, 190),
        ("N_G_N_E", "North-East Corridor Junction", "intersection", 900, 190),

        # East Corridor (x = 900 down to 800)
        ...
        # Central Internal Corridors (following real light-green corridor)
        ("N_G_C_N_PASS", "Central Corridor between Room 7/8 and Courtyard 4", "corridor", 560, 330),
        ("N_G_C_PLAZA", "Central Crossroads & Atrium Plaza", "intersection", 560, 460),
        ("N_G_C_STAIR_A", "Corridor Junction near Staircase A", "intersection", 470, 440),
        ("N_G_C_STAIR_B", "Corridor Junction near Staircase B", "intersection", 680, 470),
        ("N_G_C_STUDY21", "Central Corridor near Study Space 21", "corridor", 560, 560),
        ("N_G_C_STUDY33", "Corridor Junction near Study Space 33", "intersection", 560, 680),
        ("N_G_C_STAIR_C", "Corridor Junction near Staircase C & Store 35", "intersection", 350, 680),
    ]
    ...
    # West corridor connections
    add_edge("N_G_S_W", "N_G_W_VISITORS")
    add_edge("N_G_W_VISITORS", "N_G_W_LIFT")
    add_edge("N_G_W_LIFT", "N_G_W_STUDY43")
    add_edge("N_G_W_STUDY43", "N_G_W_PLACEMENT")
    add_edge("N_G_W_PLACEMENT", "N_G_W_N")

    # North corridor connections
    add_edge("N_G_W_N", "N_G_N_EXAM")
    add_edge("N_G_N_EXAM", "N_G_N_CENTRAL_JCT")
    add_edge("N_G_N_CENTRAL_JCT", "N_G_N_STORE")
    ...
    # Central corridor network (strictly along visible hallways)
    add_edge("N_G_N_CENTRAL_JCT", "N_G_C_N_PASS")
    add_edge("N_G_C_N_PASS", "N_G_C_PLAZA")
    add_edge("N_G_C_PLAZA", "N_G_C_STAIR_A")
    add_edge("N_G_C_PLAZA", "N_G_C_STAIR_B")
    add_edge("N_G_C_STAIR_B", "N_G_E_MID")
    add_edge("N_G_C_PLAZA", "N_G_C_STUDY21")
    add_edge("N_G_C_STUDY21", "N_G_C_STUDY33")
    add_edge("N_G_C_STUDY33", "N_G_S_MID")
    add_edge("N_G_C_STUDY33", "N_G_E_COMP")
    add_edge("N_G_C_STUDY33", "N_G_C_STAIR_C")
    add_edge("N_G_C_STAIR_C", "N_G_W_LIFT")

    # Vertical connections on Ground Floor
    add_edge("ELEV_1_0", "N_G_W_LIFT", distance=5.0, notes="West Lift Foyer")
    add_edge("STAIR_A_0", "N_G_C_STAIR_A", distance=5.0, notes="Staircase A access")
    add_edge("STAIR_B_0", "N_G_C_STAIR_B", distance=5.0, notes="Staircase B access")
    add_edge("STAIR_C_0", "N_G_C_STAIR_C", distance=5.0, notes="Staircase C access")
    add_edge("STAIR_D_0", "N_G_S_STAIR_D", distance=5.0, notes="Staircase D access")
    add_edge("STAIR_LIB_0", "N_G_S_W", distance=15.0, notes="Library spiral stair link")
    ...
    g_rooms = [
        ...
        ("LOC_G_WEST_ENT", "West Campus Entrance", "entrance", 0, 100, 880, "Campus Entry", ["west gate", "west entry", "quadrangle gate"], "Entrance near security kiosk", "N_G_S_W"),
        ("LOC_G_EAST_ENT", "East Academic Entrance", "entrance", 0, 820, 480, "Campus Entry", ["east gate", "east entry", "academic section gate"], "East entrance facing quadrangle", "N_G_E_MID"),
        ...
        ("LOC_G_STORE_11", "Central Store Room (Room 11)", "room", 0, 650, 190, "Services", ["store", "store room", "supplies", "room 11", "11"], "Ground floor, north corridor", "N_G_N_STORE"),
        ("LOC_G_PLACEMENT_EXAM", "Placement & Exam Cell (Room 14)", "office", 0, 360, 190, "Career Services", ["placement cell", "exam cell", "examination", "room 14", "14"], "Ground floor, north corridor", "N_G_N_EXAM"),
        ...
        ("LOC_G_STUDY_21", "Study Space 21", "study_area", 0, 560, 560, "Campus Common", ["study space 21", "study 21", "open study", "central study", "21"], "Central corridor, between Courtyard 2 & 4", "N_G_C_STUDY21"),
        ...
        ("LOC_G_SEMINAR_32", "Seminar Hall & Discussion Room 32", "hall", 0, 500, 740, "Campus Common", ["seminar 32", "discussion room", "room 32", "32"], "Central wing facing Courtyard 1", "N_G_C_STUDY33"),
        ("LOC_G_STUDY_33", "Courtyard Study Space 33", "study_area", 0, 645, 680, "Campus Common", ["study space 33", "study 33", "33"], "Courtyard 1 perimeter study area", "N_G_C_STUDY33"),
        ("LOC_G_GUEST_LOUNGE", "Guest Lounge & Quiet Area (Room 36)", "lounge", 0, 390, 760, "Hospitality", ["guest lounge", "quiet area", "visiting faculty lounge", "room 36", "36"], "South-west corridor", "N_G_C_STAIR_C"),
    ...
    # ==========================================
    # FLOOR 1 — FIRST FLOOR
    # Strictly aligned to light-green corridors in first.png
    # ==========================================
    f1_corridors = [
        # South Corridor
        ("N_1_S_W", "First Floor South-West Junction", "intersection", 215, 880),
        ("N_1_S_129", "First Floor South Corridor near E&C Lab-5", "corridor", 410, 880),
        ("N_1_S_128", "First Floor South Corridor near E&C Lab-4", "corridor", 570, 880),
        ...
        # West Corridor
        ("N_1_W_LIB", "First Floor West Corridor Library Entrance", "corridor", 215, 710),
        ("N_1_W_LIFT", "First Floor West Corridor Lift Foyer (Accessible)", "intersection", 215, 760),
        ...
        # North Corridor
        ("N_1_N_CAED", "First Floor North Corridor CAED Lab 112", "corridor", 360, 190),
        ("N_1_N_CENTRAL_JCT", "First Floor North Corridor Central Junction", "intersection", 560, 190),
        ...
        # Central Internal Corridors
        ("N_1_C_N_PASS", "First Floor Central Corridor between MBA Library and Courtyard 4", "corridor", 560, 330),
        ("N_1_C_PLAZA", "First Floor Central Crossroads", "intersection", 560, 460),
        ("N_1_C_STAIR_A", "First Floor Corridor near Staircase A", "intersection", 470, 440),
        ("N_1_C_STAIR_B", "First Floor Corridor near Staircase B", "intersection", 680, 470),
        ("N_1_C_STUDY119", "First Floor Central Corridor Study 119", "corridor", 560, 560),
        ("N_1_C_STUDY133", "First Floor Corridor Study 133", "intersection", 560, 680),
        ("N_1_C_STAIR_C", "First Floor Corridor near Staircase C & E&C Lab-8", "intersection", 350, 680),
    ]
    ...
    add_edge("N_1_S_W", "N_1_W_LIFT")
    add_edge("N_1_W_LIFT", "N_1_W_LIB")
    add_edge("N_1_W_LIB", "N_1_W_136")
    add_edge("N_1_W_136", "N_1_W_116")
    add_edge("N_1_W_116", "N_1_W_N")

    add_edge("N_1_W_N", "N_1_N_CAED")
    add_edge("N_1_N_CAED", "N_1_N_CENTRAL_JCT")
    add_edge("N_1_N_CENTRAL_JCT", "N_1_N_MBA_CLASS")
    ...
    add_edge("N_1_N_CENTRAL_JCT", "N_1_C_N_PASS")
    add_edge("N_1_C_N_PASS", "N_1_C_PLAZA")
    add_edge("N_1_C_PLAZA", "N_1_C_STAIR_A")
    add_edge("N_1_C_PLAZA", "N_1_C_STAIR_B")
    add_edge("N_1_C_STAIR_B", "N_1_E_MID")
    add_edge("N_1_C_PLAZA", "N_1_C_STUDY119")
    add_edge("N_1_C_STUDY119", "N_1_C_STUDY133")
    add_edge("N_1_C_STUDY133", "N_1_S_128")
    add_edge("N_1_C_STUDY133", "N_1_E_STAFF")
    add_edge("N_1_C_STUDY133", "N_1_C_STAIR_C")
    add_edge("N_1_C_STAIR_C", "N_1_W_LIFT")

    add_edge("ELEV_1_1", "N_1_W_LIFT", distance=5.0)
    add_edge("STAIR_A_1", "N_1_C_STAIR_A", distance=5.0)
    add_edge("STAIR_B_1", "N_1_C_STAIR_B", distance=5.0)
    add_edge("STAIR_C_1", "N_1_C_STAIR_C", distance=5.0)
    add_edge("STAIR_D_1", "N_1_S_129", distance=5.0)
    add_edge("STAIR_LIB_1", "N_1_W_LIB", distance=10.0)
    ...
    f1_rooms = [
        ...
        ("LOC_1_FACULTY_111", "Faculty Cabins 111", "office", 1, 580, 190, "Faculty", ["faculty cabins", "staff room 111", "room 111", "111"], "North corridor", "N_1_N_CENTRAL_JCT"),
        ...
        ("LOC_1_ELEC_PANEL", "Electrical Panel Room 118", "room", 1, 510, 480, "Services", ["electrical panel", "substation control", "room 118", "118"], "Central utility zone", "N_1_C_PLAZA"),
        ("LOC_1_STUDY_119", "Study Space 119", "study_area", 1, 510, 590, "Campus Common", ["study space 119", "study 119", "119"], "Central atrium study mezzanine", "N_1_C_STUDY119"),
    ...
    # Strictly aligned to light-green corridors in second.png
    # ==========================================
    f2_corridors = [
        # South Corridor
        ("N_2_S_W", "Second Floor South-West Junction", "intersection", 215, 880),
        ("N_2_S_233", "Second Floor South Corridor near IS Lab-5", "corridor", 410, 880),
        ("N_2_S_232", "Second Floor South Corridor near IS Lab-4", "corridor", 570, 880),
        ("N_2_S_231", "Second Floor South Corridor near Server Room", "corridor", 650, 880),
        ("N_2_S_230", "Second Floor South Corridor near IS Lab-3", "corridor", 780, 880),
        ("N_2_S_E", "Second Floor South-East Corridor Junction", "intersection", 900, 880),

        # West Corridor
        ("N_2_W_LIB", "Second Floor Library SF Entrance", "corridor", 215, 710),
        ("N_2_W_LIFT", "Second Floor West Corridor Lift Foyer (Accessible)", "intersection", 215, 760),
        ...
        ("N_2_N_CENTRAL_JCT", "Second Floor North Corridor Central Junction", "intersection", 560, 190),
        ...
        # Central Internal Corridors
        ("N_2_C_N_PASS", "Second Floor Central Corridor between Maths Dept and Courtyard 4", "corridor", 560, 330),
        ("N_2_C_PLAZA", "Second Floor Central Crossroads", "intersection", 560, 460),
        ("N_2_C_STAIR_A", "Second Floor Corridor near Staircase A", "intersection", 470, 440),
        ("N_2_C_STAIR_B", "Second Floor Corridor near Staircase B", "intersection", 680, 470),
        ("N_2_C_STUDY221", "Second Floor Corridor Study 221", "corridor", 560, 560),
        ("N_2_C_STUDY237", "Second Floor Corridor Study 237", "intersection", 560, 680),
        ("N_2_C_STAIR_C", "Second Floor Corridor near Staircase C & CS CR 236", "intersection", 350, 680),
    ]
    ...
    add_edge("N_2_S_W", "N_2_W_LIFT")
    add_edge("N_2_W_LIFT", "N_2_W_LIB")
    add_edge("N_2_W_LIB", "N_2_W_CHEM")
    add_edge("N_2_W_CHEM", "N_2_W_PHYSICS")
    add_edge("N_2_W_PHYSICS", "N_2_W_N")

    add_edge("N_2_W_N", "N_2_N_214")
    add_edge("N_2_N_214", "N_2_N_CENTRAL_JCT")
    add_edge("N_2_N_CENTRAL_JCT", "N_2_N_211")
    ...
    add_edge("N_2_N_CENTRAL_JCT", "N_2_C_N_PASS")
    add_edge("N_2_C_N_PASS", "N_2_C_PLAZA")
    add_edge("N_2_C_PLAZA", "N_2_C_STAIR_A")
    add_edge("N_2_C_PLAZA", "N_2_C_STAIR_B")
    add_edge("N_2_C_STAIR_B", "N_2_E_MID")
    add_edge("N_2_C_PLAZA", "N_2_C_STUDY221")
    add_edge("N_2_C_STUDY221", "N_2_C_STUDY237")
    add_edge("N_2_C_STUDY237", "N_2_S_232")
    add_edge("N_2_C_STUDY237", "N_2_E_STAFF")
    add_edge("N_2_C_STUDY237", "N_2_C_STAIR_C")
    add_edge("N_2_C_STAIR_C", "N_2_W_LIFT")

    add_edge("ELEV_1_2", "N_2_W_LIFT", distance=5.0)
    add_edge("STAIR_A_2", "N_2_C_STAIR_A", distance=5.0)
    add_edge("STAIR_B_2", "N_2_C_STAIR_B", distance=5.0)
    add_edge("STAIR_C_2", "N_2_C_STAIR_C", distance=5.0)
    add_edge("STAIR_D_2", "N_2_S_233", distance=5.0)
    add_edge("STAIR_LIB_2", "N_2_W_LIB", distance=10.0)
    ...
    f2_rooms = [
        ...
        ("LOC_2_MATH_213", "Mathematics Department (Room 213)", "department", 2, 480, 190, "Mathematics", ["mathematics", "maths dept", "room 213", "213"], "2nd Floor north corridor", "N_2_N_CENTRAL_JCT"),
        ("LOC_2_ENG_CR_211", "Engineering Classroom 211", "classroom", 2, 670, 190, "Engineering", ["room 211", "cr 211", "211"], "2nd Floor north corridor", "N_2_N_211"),
        ("LOC_2_FACULTY_201", "Faculty Cabins 201", "office", 2, 820, 190, "Faculty", ["faculty 201", "room 201", "201"], "2nd Floor north-east corridor", "N_2_N_201"),
        ("LOC_2_MBA_CR_202", "MBA Classroom 202", "classroom", 2, 820, 285, "Management Studies", ["mba cr 202", "mba 202", "room 202", "202"], "2nd Floor east wing", "N_2_E_MBA202"),
        ("LOC_2_MBA_CR_203", "MBA Classroom 203", "classroom", 2, 820, 360, "Management Studies", ["mba cr 203", "mba 203", "room 203", "203"], "2nd Floor east wing", "N_2_E_MBA203"),
        ("LOC_2_DRAWING_219", "Drawing & Design Studio (Room 219)", "room", 2, 330, 460, "Engineering", ["drawing room 219", "design studio", "room 219", "219"], "2nd Floor central hall", "N_2_C_STAIR_A"),
        ("LOC_2_INTEL_LAB", "Intel Intelligence & AI Lab (Room 220)", "lab", 2, 510, 480, "Artificial Intelligence", ["intel lab", "ai lab", "intel iot lab", "room 220", "220"], "2nd Floor central lab", "N_2_C_PLAZA"),
        ("LOC_2_STUDY_207", "Study Space 207", "study_area", 2, 590, 440, "Campus Common", ["study space 207", "study 207", "207"], "Near Staircase B", "N_2_C_STAIR_B"),
        ("LOC_2_IS_CR_206", "Information Science Classroom 206", "classroom", 2, 740, 465, "Information Science", ["is cr 206", "room 206", "206"], "2nd Floor east central corridor", "N_2_C_STAIR_B"),
        ("LOC_2_PHYSICS_LAB", "Engineering Physics Lab (Room 217)", "lab", 2, 140, 370, "Physics", ["physics lab", "physics laboratory", "room 217", "217"], "2nd Floor west corridor", "N_2_W_PHYSICS"),
        ("LOC_2_CHEM_LAB", "Engineering Chemistry Lab (Room 240)", "lab", 2, 140, 550, "Chemistry", ["chemistry lab", "chemistry laboratory", "chem lab", "room 240", "240"], "2nd Floor west corridor", "N_2_W_CHEM"),
        ("LOC_2_LIB_SF", "Central Library (Second Floor Mezzanine)", "library", 2, 235, 800, "Library", ["library sf", "library mezzanine", "reading hall", "digital library", "room 239", "239"], "2nd Floor west wing library", "N_2_W_LIB"),
        ("LOC_2_STUDY_221", "Study Space 221", "study_area", 2, 510, 590, "Campus Common", ["study space 221", "study 221", "221"], "Central atrium study space", "N_2_C_STUDY221"),
        ("LOC_2_CS_HOD", "Department of Computer Science & HOD Chamber", "office", 2, 850, 610, "Computer Science", ["cs hod", "cse department 2nd floor", "hod chamber"], "East corridor academic section", "N_2_E_STAFF"),
        ("LOC_2_STUDY_237", "Study Space 237", "study_area", 2, 590, 675, "Campus Common", ["study space 237", "study 237", "237"], "Courtyard 1 perimeter study deck", "N_2_C_STUDY237"),
        ("LOC_2_CS_CR_226", "Computer Science Classroom 226", "classroom", 2, 880, 740, "Computer Science", ["cs cr 226", "room 226", "226"], "East corridor classroom", "N_2_E_CS_CR"),
        ("LOC_2_IS_LAB_2", "IS Lab-2 (Room 229)", "lab", 2, 880, 880, "Information Science", ["is lab 2", "room 229", "229"], "South-east corner laboratory", "N_2_S_E"),
        ("LOC_2_IS_LAB_3", "IS Lab-3 (Room 230)", "lab", 2, 700, 880, "Information Science", ["is lab 3", "room 230", "230"], "South corridor laboratory", "N_2_S_230"),
        ("LOC_2_IS_LAB_4", "IS Lab-4 (Room 232)", "lab", 2, 550, 880, "Information Science", ["is lab 4", "room 232", "232"], "South corridor laboratory", "N_2_S_232"),
        ("LOC_2_IS_LAB_5", "IS Lab-5 (Room 233)", "lab", 2, 430, 880, "Information Science", ["is lab 5", "room 233", "233"], "South corridor laboratory near Staircase D", "N_2_S_233"),
        ("LOC_2_CS_CR_236", "Computer Science Classroom 236", "classroom", 2, 385, 665, "Computer Science", ["cs cr 236", "room 236", "236"], "Center west classroom near Staircase C", "N_2_C_STAIR_C"),
        ("LOC_2_WORKSHOP_242", "Workshop 2nd Floor - Hands-on Lab 1 (Room 242)", "workshop", 2, 380, 80, "Mechanical", ["workshop 242", "hands on lab 1", "room 242", "242"], "Workshop second floor wing", "STAIR_WS_2"),
        ("LOC_2_WORKSHOP_243", "Workshop 2nd Floor - Hands-on Lab 2 (Room 243)", "workshop", 2, 200, 80, "Mechanical", ["workshop 243", "hands on lab 2", "room 243", "243"], "Workshop second floor wing", "STAIR_WS_2")
    ]
    ...
    # ==========================================
    # FLOOR 3 — THIRD FLOOR
    # Strictly aligned to light-green corridors in third.png
    # (No West elevator on Floor 3; bottom-left is open terrace/pool)
    # ==========================================
    f3_corridors = [
        # South Corridor
        ("N_3_S_W", "Third Floor South-West Junction", "intersection", 350, 880),
        ("N_3_S_337", "Third Floor South Corridor Classroom 337", "corridor", 410, 880),
        ...
        # West Corridor
        ("N_3_W_TERRACE", "Third Floor West Corridor Pool Terrace", "corridor", 215, 680),
        ("N_3_W_CR", "Third Floor West Corridor Classroom Wing", "corridor", 215, 440),
        ("N_3_W_N", "Third Floor North-West Corridor Junction", "intersection", 215, 190),

        # North Corridor
        ("N_3_N_316", "Third Floor North Corridor Civil CR 316", "corridor", 360, 190),
        ("N_3_N_CENTRAL_JCT", "Third Floor North Corridor Central Junction", "intersection", 560, 190),
        ...
        # Central Internal Corridors
        ("N_3_C_N_PASS", "Third Floor Central Corridor", "corridor", 560, 330),
        ("N_3_C_PLAZA", "Third Floor Central Crossroads", "intersection", 560, 460),
        ("N_3_C_STAIR_A", "Third Floor Corridor near Staircase A", "intersection", 470, 440),
        ("N_3_C_STAIR_B", "Third Floor Corridor near Staircase B", "intersection", 680, 470),
        ("N_3_C_MID_SOUTH", "Third Floor Central South Corridor", "corridor", 560, 680),
        ("N_3_C_STAIR_C", "Third Floor Corridor near Staircase C", "intersection", 350, 680),
    ]
    ...
    add_edge("N_3_W_TERRACE", "N_3_W_CR")
    add_edge("N_3_W_CR", "N_3_W_N")

    add_edge("N_3_W_N", "N_3_N_316")
    add_edge("N_3_N_316", "N_3_N_CENTRAL_JCT")
    add_edge("N_3_N_CENTRAL_JCT", "N_3_N_STAFF")
    ...
    add_edge("N_3_N_CENTRAL_JCT", "N_3_C_N_PASS")
    add_edge("N_3_C_N_PASS", "N_3_C_PLAZA")
    add_edge("N_3_C_PLAZA", "N_3_C_STAIR_A")
    add_edge("N_3_C_PLAZA", "N_3_C_STAIR_B")
    add_edge("N_3_C_STAIR_B", "N_3_E_MID")
    add_edge("N_3_C_PLAZA", "N_3_C_MID_SOUTH")
    add_edge("N_3_C_MID_SOUTH", "N_3_S_339")
    add_edge("N_3_C_MID_SOUTH", "N_3_E_CAD")
    add_edge("N_3_C_MID_SOUTH", "N_3_C_STAIR_C")
    add_edge("N_3_C_STAIR_C", "N_3_S_W")

    add_edge("STAIR_A_3", "N_3_C_STAIR_A", distance=5.0)
    add_edge("STAIR_B_3", "N_3_C_STAIR_B", distance=5.0)
    add_edge("STAIR_C_3", "N_3_C_STAIR_C", distance=5.0)
    add_edge("STAIR_D_3", "N_3_S_337", distance=5.0)
    ...
    f3_rooms = [
        ...
        ("LOC_3_CR_318", "Classroom 318", "classroom", 3, 360, 190, "Engineering", ["room 318", "cr 318", "318"], "3rd Floor north wing", "N_3_N_316"),
        ...
        ("LOC_3_TRAINING", "Training & Placement Cell (Room 334)", "office", 3, 510, 480, "Career Services", ["training cell", "placement training", "room 334", "334"], "3rd Floor central wing", "N_3_C_PLAZA"),
    ...
    # Strictly aligned to fourth.png (North & East wings only; South is open terrace)
    # ==========================================
    f4_corridors = [
        ("N_4_W_N", "Fourth Floor North-West Corridor Junction", "intersection", 215, 190),
        ("N_4_N_411", "Fourth Floor North Corridor E&C Lab-4", "corridor", 360, 190),
        ("N_4_N_CENTRAL_JCT", "Fourth Floor North Corridor Central Junction", "intersection", 560, 190),
        ...
        ("N_4_C_N_PASS", "Fourth Floor Central Corridor", "corridor", 560, 330),
        ("N_4_C_PLAZA", "Fourth Floor Central Crossroads", "intersection", 560, 460),
        ("N_4_C_STAIR_A", "Fourth Floor Corridor near Staircase A", "intersection", 470, 440),
        ("N_4_C_STAIR_B", "Fourth Floor Corridor near Staircase B", "intersection", 680, 470),
        ("N_4_TERRACE", "Fourth Floor Rooftop Garden Promenade", "corridor", 500, 600),
    ]
    for cid, cname, ctype, cx, cy in f4_corridors:
        nodes.append({"id": cid, "name": cname, "type": ctype, "floor": 4, "x": cx, "y": cy, "accessible": True})

    add_edge("N_4_W_N", "N_4_N_411")
    add_edge("N_4_N_411", "N_4_N_CENTRAL_JCT")
    add_edge("N_4_N_CENTRAL_JCT", "N_4_N_408")
    ...
    add_edge("N_4_N_CENTRAL_JCT", "N_4_C_N_PASS")
    add_edge("N_4_C_N_PASS", "N_4_C_PLAZA")
    add_edge("N_4_C_PLAZA", "N_4_C_STAIR_A")
    add_edge("N_4_C_PLAZA", "N_4_C_STAIR_B")
    add_edge("N_4_C_STAIR_B", "N_4_E_MID")
    add_edge("N_4_C_PLAZA", "N_4_TERRACE")

    add_edge("STAIR_A_4", "N_4_C_STAIR_A", distance=5.0)
    add_edge("STAIR_B_4", "N_4_C_STAIR_B", distance=5.0)
    ...
    f4_rooms = [
        ...
        ("LOC_4_EC_LAB_5", "E&C VLSI Design Lab-5 (Room 410)", "lab", 4, 460, 190, "Electronics & Comm", ["ec lab 410", "vlsi design lab", "room 410", "410"], "4th Floor lab", "N_4_N_CENTRAL_JCT"),
        ...
        ("LOC_4_DRESS_ROOM", "Common Room & Activity Center (Room 414)", "lounge", 4, 240, 190, "Student Welfare", ["common room 414", "dress common room", "room 414", "414"], "4th Floor north-west common lounge", "N_4_W_N"),
        ...
        ("LOC_4_ROOFTOP_GARDEN", "Sky Garden & Rooftop Terrace", "lounge", 4, 500, 600, "Campus Common", ["sky garden", "rooftop garden", "terrace garden", "4th floor terrace"], "4th Floor expansive landscaped open terrace", "N_4_TERRACE"),
    ...
    # ==========================================
    # FLOOR 5 — FIFTH FLOOR
    # Strictly aligned to fifth.png (Courtyard 4 ring only; rest is open riverview terrace)
    # ==========================================
    f5_corridors = [
        ...
        ("N_5_C_STAIR_B", "Fifth Floor Corridor near Staircase B", "intersection", 680, 470),
        ("N_5_C_STUDY506", "Fifth Floor Study Space 506", "corridor", 590, 460),
        ("N_5_TERRACE", "Fifth Floor Panoramic Riverview Promenade", "corridor", 500, 600),
    ]
    for cid, cname, ctype, cx, cy in f5_corridors:
        nodes.append({"id": cid, "name": cname, "type": ctype, "floor": 5, "x": cx, "y": cy, "accessible": True})

    # Closed ring around Courtyard 4
    ...
    add_edge("N_5_E_MID", "N_5_C_STAIR_B")
    add_edge("N_5_C_STAIR_B", "N_5_C_STUDY506")
    add_edge("N_5_C_STUDY506", "N_5_C_APTRA")
    add_edge("N_5_C_APTRA", "N_5_N_INCUBATION")
    add_edge("N_5_C_STUDY506", "N_5_TERRACE")

    add_edge("STAIR_B_5", "N_5_C_STAIR_B", distance=5.0)
    ...
    f5_rooms = [
        ...
        ("LOC_5_STUDY_506", "Rooftop Study Space (Room 506)", "study_area", 5, 590, 450, "Campus Common", ["study space 506", "rooftop study", "room 506", "506"], "5th floor quiet study area adjacent to Staircase B", "N_5_C_STUDY506"),
        ("LOC_5_ROOFTOP_TERRACE", "Panoramic Riverview Rooftop Promenade", "lounge", 5, 500, 600, "Campus Common", ["riverview promenade", "rooftop terrace", "5th floor view", "viewpoint"], "5th floor rooftop overlook viewing the Netravati river", "N_5_TERRACE"),
    ]
    ...
    qr_data = [
        ...
        {"id": "QR-G-ENT-W", "code": "SAHYADRI_QR_G_ENT_W", "name": "Ground Floor · West Courtyard Gate", "floor": 0, "node_id": "N_G_S_W", "physical_location": "West Gate Pillar near Visitors Lounge", "sample_qr_data": "https://sahyadri-nav.campus/qr?code=SAHYADRI_QR_G_ENT_W"},
    ...
    initial_issues = [
        {
            ...
            "node_ids": ["STAIR_A_0", "STAIR_A_1", "STAIR_A_2", "STAIR_A_3", "STAIR_A_4"],
            "edge_ids": [],
            "floor": 1,
            "status": "active",
            "severity": "high",
    ...
    # Save to frontend/src/data/ for 100% offline fallback demo capability
